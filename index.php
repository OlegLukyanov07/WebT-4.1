...
$info = [
    [
        'work_name' => 'Доставщик пиццы',
        'work_date' => 'Май 2019 - Август 2020',
        'work_descrip' => 'Пица, которую я приношу Вам - еще не успевала остыть и обычно была в целой упаковке',
    ],
    [
        'work_name' => 'Заводчик голубей',
        'work_date' => 'Сентябрь 2020 - Ноябрь 2021',
        'work_descrip' => 'Голуби приносят почту и хорошие новости. Я занимался созданием хороших новостей',
    ],
    [
        'work_name' => 'Разработчик летательных аппаратов',
        'work_date' => 'Декабрь 2021 - По настоящее время',
        'work_descrip' => 'Мои летательные аппараты в настоящее время - лучшие в мире! Правда, ни один из них еще не летает - но, я над этим работаю!',
    ],
];
